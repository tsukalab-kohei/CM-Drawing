...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        NSString *path_hover = [[NSBundle mainBundle] pathForResource:@"explode" ofType:@"wav"];
        NSURL *url_hover = [NSURL fileURLWithPath:path_hover];
        self.hoverSound = [[AVAudioPlayer alloc] initWithContentsOfURL:url_hover error:NULL];
        
        NSString *path_touch = [[NSBundle mainBundle] pathForResource:@"waterdrop" ofType:@"wav"];
        NSURL *url_touch = [NSURL fileURLWithPath:path_touch];
        self.touchSound = [[AVAudioPlayer alloc] initWithContentsOfURL:url_touch error:NULL];
...
- (void)drawRect:(CGRect)rect {
    ...
    UIColor *dblue = [UIColor colorWithRed:0x33/255.0 green:0 blue:0x99/255.0 alpha:0.5];
    ...
    */
    ...
    if(self.capaRecog){
        ...
        */
        ...
        [self generateParticleInTouchState];
...
- (void)generateParticle {
    NSLog(@"generate");
    self.emitterLayer.emitterPosition = CGPointMake(self.arLocaCGPoint.x, self.arLocaCGPoint.y);
    ...
    emittercell.color = [UIColor colorWithRed:0.5 green:0.5 blue:0.5 alpha:0.5].CGColor;
    
    self.emitterLayer.emitterCells = @[emittercell];
}

- (void)generateParticleInTouchState {
    self.emitterLayer.emitterPosition = CGPointMake(center.x, center.y);
    ...
    emittercell.lifetimeRange = 1.2;
    emittercell.velocity = 240;
    emittercell.color = [UIColor colorWithRed:0.1 green:0.56 blue:0.9 alpha:0.5].CGColor;
    ...
    */
    ...
    baseCell.birthRate = 100;
    baseCell.velocity = 400;
    baseCell.velocityRange = 50;
    baseCell.yAcceleration = 300;
    baseCell.color = CGColorCreateCopy([UIColor colorWithRed:0.1
                                                       green:0.2
                                                        blue:1.0
                                                       alpha:0.5].CGColor);
    ...
    sparkCell.contents = (__bridge id)image.CGImage;
    sparkCell.emissionRange = 2 * M_PI;
    sparkCell.birthRate = 500;
    sparkCell.scale = 0.5;
